...
//         <p className=''> My name is Alex, and I love capturing moments in time through the lens of my drones whether that is a photo or video.</p>
//         <img className='child' src={RAW} alt='' height='250' width='250' />
...
//         <p className='childtwo'> I have always wanted to fly, so I decided to buy a dji mini 3 pro since I was fascinated by its capabilities. 
//           When I launched it for the first time and flew out into the Hudson River, life was never the same to me. 
//           I have been flying since, trying to see the world in a completely new way, from above. 
//           I specifically enjoy capturing content of vehicles, their mechanical operation, their speed and power, their engaging appearance, and the sound of when they takeoff. 
//           Whether you have good or bad memory, you cannot relive the past. The closest we get to that would be through our gallery. Sometimes we cannot live in our moment to the fullest since we desire to capture it ourselves.
//    I want you to live in your moment while I capture every second of it knowing one day you will enjoy these time capsules showcasing the magic you have experienced.  
//    </p>
...
// {/* <img src={RAW} alt='' height='10' width='10' /> */}
