...
import anime from "animejs"; // Ensure you have animejs installed
...
const SliderComponent = () => {
  useEffect(() => {
    ...
    return () => {
      slider.nextButton.removeEventListener("click", slider.goNext);
      slider.prevButton.removeEventListener("click", slider.goPrev);
      slider.navBar.removeEventListener("click", slider._navClickHandler);
    };
  }, []);
